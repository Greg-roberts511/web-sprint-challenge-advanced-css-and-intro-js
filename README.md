...
Accessibility on the web allows users who may have visual or audio impairments to view and use the webpage.

2. Talk about 3 different things you can do to ensure your website is accessible.

Use semantic html mark up, using headings, alternate text options for images, declaring the lang for screen readers, and proper language.

3. How would you explain the concept of a variable to someone new to programming?

A variable in javascript is a container for data declared by using var, let, or const.

4. What is the purpose of using functions in code?

A function is like a blueprint or structure of code that holds data or statements to perform a task. The function should take an input of data and return an output which can be anything based on the code within the function.
